class VigenereCipheringMachine {
    ...
    decrypt(str, key) {
        ...
        for(let i in str) {
            ...
            let keyLetterIndexInAlfabet = chars.indexOf(key[currentIndex%keyLength]);
            decryptedLetter = decryptedLetter + chars[(currentLetterIndexInAlfabet - keyLetterIndexInAlfabet + 26) % 26];
            currentIndex += 1;
        }
